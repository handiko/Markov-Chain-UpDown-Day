...
This chapter's goal is simple: **What is the transition probabilities of a previous up/down day to the next day's state?** Either it more probable to be an up day or a down day?
